...
public class DbTableStrings {
    public static final String TABLE_NAME_USER_MODEL = "user_model";
    ...
    public static final String REQUEST_EUSER_ID = "request_euser_id";
    ...
    public static final String ACTUAL_ANSWER = "actual_answer";
